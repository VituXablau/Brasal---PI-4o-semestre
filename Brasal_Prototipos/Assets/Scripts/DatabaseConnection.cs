...
public class DatabaseConnection : MonoBehaviour
{
    ...
    private void DatabaseMataAtlantica()
    {
        ...
        if (reader.Read())
        {
            ...
            Debug.Log("Valores Mata Atl�ntica:" + " " + GameManager.medals_MataAtlantica[0] + " " + GameManager.medals_MataAtlantica[1] + " " + GameManager.medals_MataAtlantica[2] + " " + GameManager.maxPercentage[0] + GameManager.maxAnimals[0]); //lembrar de tirar depois, � s� para observa��o
        }
    }
